...
Open a terminal and navigate to the same folder where this README (the folder is called A*JPS). Then type the following command: "java -jar A*JPS.jar" (without the apostrophes of course)
...
When the representation is finished the entire path as nodes are shown and how many steps long it was. How much time the algorithm used to calculate the path is also shown.
